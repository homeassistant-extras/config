 ...
 * @param {string[]} [options.cardFiles] Lit/web-component file globs.
 */
export function createCardEslintConfig(options = {}) {
  const {
    tsconfigRootDir = import.meta.dirname,
    ignores = [],
    cardFiles = defaultCardFiles,
  } = options;
